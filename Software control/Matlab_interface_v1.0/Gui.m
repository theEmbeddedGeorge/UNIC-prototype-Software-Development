...
% Last Modified by GUIDE v2.5 17-Oct-2015 23:57:18
...
% --- Executes on button press in Read_voltage.
function Read_voltage_Callback(hObject, eventdata, handles)
% hObject    handle to Read_voltage (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
Excel = 'Test.xlsx';
...
Serial_port = get(hObject,'String');
