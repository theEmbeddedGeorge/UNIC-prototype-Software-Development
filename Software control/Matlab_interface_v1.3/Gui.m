...
% Last Modified by GUIDE v2.5 09-Jul-2016 17:58:29
...
Num_slice = 0;
signal = 1;
refresh_rate = 0.02; %the refreshing rate must be faster than the sensing rate
resistance = 0.25;
error_tolerance = 20;
...
if get(handles.Current_Monitor,'Value') == get(handles.Current_Monitor,'Max')
    ...
    Board1_clear_Callback(handles.Board2_clear, eventdata,handles);
    Board1_clear_Callback(handles.Board3_clear, eventdata,handles);
    Board1_clear_Callback(handles.Board4_clear, eventdata,handles);
    Board1_clear_Callback(handles.Board5_clear, eventdata,handles);
    ...
    set(handles.Volt_send,'Enable','off');
    set(handles.Disconnect,'Enable','off');
    set(handles.Error_tolerance_text,'String','Error_tolerance (%) Def: 20%');
 ...
 %if toggle button is pushed and detect arduino conection 
    ...
    %% Read board 2 current vals
       if ad_val2 == 1
           ...
           switch temp2(1)
               case 'A'
                     error_eval(handles.Board2_A,handles.Board2_A_input,temp2,temp2_double,error_tolerance);
               case 'B'
                     error_eval(handles.Board2_B,handles.Board2_B_input,temp2,temp2_double,error_tolerance);
               case 'C'
                     error_eval(handles.Board2_C,handles.Board2_C_input,temp2,temp2_double,error_tolerance);
               case 'D'
                     error_eval(handles.Board2_D,handles.Board2_D_input,temp2,temp2_double,error_tolerance);
               case 'E'
                     error_eval(handles.Board2_E,handles.Board2_E_input,temp2,temp2_double,error_tolerance);
           end 
       end
    %% Read board 3 current vals
       if ad_val3 == 1
           ...
           switch temp3(1)
               case 'A'
                     error_eval(handles.Board3_A,handles.Board3_A_input,temp3,temp3_double,error_tolerance);
               case 'B'
                     error_eval(handles.Board3_B,handles.Board3_B_input,temp3,temp3_double,error_tolerance);
               case 'C'
                     error_eval(handles.Board3_C,handles.Board3_C_input,temp3,temp3_double,error_tolerance);
               case 'D'
                     error_eval(handles.Board3_D,handles.Board3_D_input,temp3,temp3_double,error_tolerance);
               case 'E'
                     error_eval(handles.Board3_E,handles.Board3_E_input,temp3,temp3_double,error_tolerance);
           end 
       end
    %% Read board 4 current vals
       if ad_val4 == 1
           ...
           switch temp4(1)
               case 'A'
                     error_eval(handles.Board4_A,handles.Board4_A_input,temp4,temp4_double,error_tolerance);
               case 'B'
                     error_eval(handles.Board4_B,handles.Board4_B_input,temp4,temp4_double,error_tolerance);
               case 'C'
                     error_eval(handles.Board4_C,handles.Board4_C_input,temp4,temp4_double,error_tolerance);
               case 'D'
                     error_eval(handles.Board4_D,handles.Board4_D_input,temp4,temp4_double,error_tolerance);
               case 'E'
                     error_eval(handles.Board4_E,handles.Board4_E_input,temp4,temp4_double,error_tolerance);
           end 
       end
    %% Read board 5 current vals
       if ad_val5 == 1
           ...
           switch temp5(1)
               case 'A'
                     error_eval(handles.Board5_A,handles.Board5_A_input,temp5,temp5_double,error_tolerance);
               case 'B'
                     error_eval(handles.Board5_B,handles.Board5_B_input,temp5,temp5_double,error_tolerance);
               case 'C'
                     error_eval(handles.Board5_C,handles.Board5_C_input,temp5,temp5_double,error_tolerance);
               case 'D'
                     error_eval(handles.Board5_D,handles.Board5_D_input,temp5,temp5_double,error_tolerance);
               case 'E'
                     error_eval(handles.Board5_E,handles.Board5_E_input,temp5,temp5_double,error_tolerance);
           end 
       end
